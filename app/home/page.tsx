          ...
          <div className="grid lg:grid-cols-[minmax(0,1.08fr)_minmax(320px,0.92fr)] gap-8 lg:gap-14 items-start">
            ...
            <div className="relative flex items-start justify-center pt-2 md:pt-4 lg:pt-0 p-2 md:p-6 animate-fade-up-delay">
              ...
              <div className="relative w-full max-w-[320px] animate-float-soft">
                ...
                <div className="absolute -right-32 bottom-20 z-20 hidden xl:flex max-w-[240px] items-center gap-3 rounded-2xl border border-white/10 bg-[#09111b]/88 px-4 py-3 backdrop-blur shadow-[0_18px_40px_rgba(0,0,0,0.35)]">
